Attribute VB_Name = "JoyStickMod"
' K2W JoyMouse - Game Device Input to Mouse Input Converter
' Copyright (C) 1999  William A. Sattler
'
...
'This Code was Taken from www.extreme-vb.net
'all code original
